...
void PerfectMatching::ComputeEpsGlobal()
{
	...
	for (r=nodes[node_num].tree_sibling; r; r=r->tree_sibling)
	{
		t = r->tree;
		t->id = N;
		N += 2;
...
void PerfectMatching::ComputeEpsSCC()
{
	...
	for (r=nodes[node_num].tree_sibling; r; r=r->tree_sibling) r->tree->dfs_parent = NULL;
...
void PerfectMatching::CommitEps()
{
	...
	for (r=nodes[node_num].tree_sibling; r; r=r->tree_sibling) r->tree->eps = 0;
}

bool PerfectMatching::UpdateDuals()
{
	Node* r;
	Node* r_prev = &nodes[node_num];

	double start_time = get_time();

	////////////////////////////////////////////////////////////////////////////////////
	for (r=nodes[node_num].tree_sibling; r; r_prev=r, r=r->tree_sibling)
	{
		Tree* t = r->tree;
		PriorityQueue<REAL>::Item* q;
		REAL eps = PM_INFTY;
